...
def intro(fuel, food, power, hull, crew, morale):
    ...
    print("The year is 202020, and Earth Force Captain, *Chough-Chough* (That’s you!) is returning to ")
    print("base after another successful mission. Star Gazer 1, An earth outpost, had been the captain’s ")
    print("home away from home for some time now. The Garquackien threat necessitated round the ")
    print("clock vigil of the neutral space separating Earth Force from the Garquackien empire and its")
    print("quest for galactic domination. As the ship approached the Captain was looking forward to some ")
    print("well-deserved R&R when studently…")
    print("")
    print("press ENTER to continue")
    input()
    print("")
    print("As you arrive within scanning distance find only broken metal and empty space where Star ")
    print("Gazer should be. To make matters worse, sensors are picking up several Garquackien ships still ")
    print("in the area. Thanks to your years, in the captain’s seat, you quickly piece together what has ")
    print("happened. The Garquackiens must have amassed a large armada, the likes of which the ")
